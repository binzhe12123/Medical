...
function ML008() {//ML008-医药机构药品目录备案
    ...
    var listInfo = [{
        ake001: DataBase.YPML[0].ake001,//社保目录编码 not null
        ake002: DataBase.YPML[0].ake002,
        bkm017: DataBase.YPML[0].bkm017,//药品本位码 not null
        ake005: DataBase.YPML[0].ake005,//医疗机构三大目录编码 not null
        ake006: DataBase.YPML[0].ake006,//医药机构三大目录名称 not null
        aka074: DataBase.YPML[0].aka074,//规格 not null
        aka070: DataBase.YPML[0].aka070,//剂型 not null
        aka064: DataBase.YPML[0].aka064,
        aka067: DataBase.YPML[0].aka067,//计价单位  null
        bka053: DataBase.YPML[0].bka053,//厂家     null
        bka505: DataBase.YPML[0].bka505,//药品进货价格   not  null
        bka506: DataBase.YPML[0].bka506,//药品收费价格   not  null
        aae030: DataBase.YPML[0].aae030,//备案日期   not  null
        aae013: DataBase.YPML[0].aae013//备注     null
    }, {
        ake001: DataBase.YPML[1].ake001,//社保目录编码 not null
        ake002: DataBase.YPML[1].ake002,
        bkm017: DataBase.YPML[1].bkm017,//药品本位码 not null
        ake005: DataBase.YPML[1].ake005,//医疗机构三大目录编码 not null
        ake006: DataBase.YPML[1].ake006,//医药机构三大目录名称 not null
        aka074: DataBase.YPML[1].aka074,//规格 not null
        aka070: DataBase.YPML[1].aka070,//剂型 not null
        aka064: DataBase.YPML[1].aka064,
        aka067: DataBase.YPML[1].aka067,//计价单位  null
        bka053: DataBase.YPML[1].bka053,//厂家     null
        bka505: DataBase.YPML[1].bka505,//药品进货价格   not  null
        bka506: DataBase.YPML[1].bka506,//药品收费价格   not  null
        aae030: DataBase.YPML[1].aae030,//备案日期   not  null
        aae013: DataBase.YPML[1].aae013//备注     null
    }];
...
function FY001() {
    ...
    NumberData.aae072 = [];
    NumberData.aae072[0] = paras.RandomNum(20);
    NumberData.aae072[1] = paras.RandomNum(20);
    NumberData.bkf500 = [];
    NumberData.bkf500[0] = paras.RandomNum(18);
    NumberData.bkf500[1] = paras.RandomNum(18);
    paras.transTime = paras.Milliseconds();
    paras.transType = "FY001";
    var listInfo = [{
        aae072: NumberData.aae072[0],//NumberData.aae072,
        bkc369: DataBase.YPML[0].wg,
        bkf500: NumberData.bkf500[0],
        ake001: DataBase.YPML[0].ake001,
        ake002: DataBase.YPML[0].ake006,
        bkm017: DataBase.YPML[0].bkm017,
        aka064: 0,
        ake005: DataBase.YPML[0].ake005,
        ake006: DataBase.YPML[0].ake006,
        akc226: 1,
        akc264: DataBase.YPML[0].bka506,
        akc225: DataBase.YPML[0].bka506,
        aka067: "次",
        akc271: 20180402,
        bkc320: DataBase.Doctor.bkc320,
        ckm113:"口服"
    }, {
        aae072: NumberData.aae072[1],//NumberData.aae072,
        bkc369: DataBase.YPML[1].wg,
        bkf500: NumberData.bkf500[1],
        ake001: DataBase.YPML[1].ake001,
        ake002: DataBase.YPML[1].ake006,
        bkm017: DataBase.YPML[1].bkm017,
        aka064: 0,
        ake005: DataBase.YPML[1].ake005,
        ake006: DataBase.YPML[1].ake006,
        akc226: 1,
        akc264: 0,//DataBase.YPML[0].bka506,
        akc225: 0,//DataBase.YPML[0].bka506,
        aka067: "次",
        akc271: 20180402,
        bkc320: DataBase.Doctor.bkc320,
        ckm113: "口服"
