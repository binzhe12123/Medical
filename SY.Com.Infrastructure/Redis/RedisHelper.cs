...
namespace SY.Com.Infrastructure
{
    ...
    public class RedisHelper
    {
        ...
        public List<T> HashValues<T>(string value)
        {
            value = AddSysCustomKey(value);
            return Do(db =>
            {
                RedisValue[] values = db.HashValues(value);
                return ConvetList<T>(values);
            });
        }
        ...
        public HashEntry[] HashGetAll(string key)
        {
            ...
            return Do(db =>
            {
                HashEntry[] values = db.HashGetAll(key);//.HashValues(value);
                return values;
            });
        }
