...
namespace SY.Com.Infrastructure
{
    public class DEncrypt
    {
        ...
        /// <returns></returns>
        public static string DesEncrypt(string beinetstr, string beinetkey = "www")
        {
        ...
        public static string RSAEncrypt( string content, string publickey = "")
        {
            if (publickey == "")
            {
                publickey = @"<RSAKeyValue><Modulus>q5OEyJqZD0UU2cXTzq2BIvse3EWZn9sd+qLp31ff8xuYD7OH1XSZ222Snkw6Qk8HPpBDhYRgkf1qV5wT4nop3eOcvG1eZbRhufMVjbPfErNPsQwH2eVjSeWblatzv1T2aWtACb/LUNzobjL7S2JT6TNvEreo3Uv+80+iK26iYj8=</Modulus><Exponent>AQAB</Exponent></RSAKeyValue>";
            }            
        ...
        public static string RSADecrypt( string content, string privatekey = "")
        {
            if (privatekey == "")
            {
                privatekey = @"<RSAKeyValue><Modulus>q5OEyJqZD0UU2cXTzq2BIvse3EWZn9sd+qLp31ff8xuYD7OH1XSZ222Snkw6Qk8HPpBDhYRgkf1qV5wT4nop3eOcvG1eZbRhufMVjbPfErNPsQwH2eVjSeWblatzv1T2aWtACb/LUNzobjL7S2JT6TNvEreo3Uv+80+iK26iYj8=</Modulus><Exponent>AQAB</Exponent><P>3grh22B2NVPf0rrBVTHZg3wDj70wAi5ZBFWh1ngAEDRaP6RPkI42GV3MpG35sz4dUeFALIW2mlwuvuenWP7AIQ==</P><Q>xdDY6QDAmnVLhpJNHWCHJQ3Snja+6Y/HgxiCnV0ELZoD8NAiBMqZenUpVPnywwGk3wv2/OAjWTzgUXAqGc5WXw==</Q><DP>zUdISZXjkyfI3Ly1snrUul9zt3bTpKCOwZgdd/cXL+QGr6HLwTwIvejfIgFegZziZGmX99Fi4VBqEyp9p6RVoQ==</DP><DQ>xbmqhsPUwM8LbfigkgOhMh1t7+ziyQyJLPV74RVPjtFKrRMtXcKwxGGFrcWkrNzg0n3gJAVZ7+HUijJmMqM3Ww==</DQ><InverseQ>u3LEzv67AExkoUoShmQ9UGPlsPQc5kUqaBK3/EHEP4mlZOIxC5MZiM3lyjysFJIKFhAppaIkQOOBwxAnjqtFcA==</InverseQ><D>fhypLfYMaN/jCorRO4nmcHraXRe/anNZXr9eXe6uSnfO1kOkpO3WpSWt7jKjY9fIwGCzcLEzdjspbgnnx8D5gc1OpVS7/DrEM5SvfXHW2Mr4UP6I717d2kFB74TtZCEKKu7ldQxGK+c3I65WNyAZU+8Q2fuAIDZadmFa2jczuUE=</D></RSAKeyValue>";
            }            
            RSACryptoServiceProvider rsa = new RSACryptoServiceProvider();
            byte[] cipherbytes;
    ...
    /// 旧版诊所软件的加密操作类
    /// </summary>
    public class OldClinicDEncrypt
    {
